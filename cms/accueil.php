...
<head>
    ...
    <title id="index1">Codd(in) | Accueil</title>
    ...
    <div class="web-content">
        <div class="section accueil">
            <div class="row">
                ...
                <div class="col col-2">
                    <div class="text">
                        <h1 id="index2"><span class="titre-dot">.</span>Notre agence</h1>
                        <p id="index3">Codd in, c’est votre agence de développement web. Nous nous occupons de la réalisation de
        ...
        <div class="section pole">
            <div class="row" style="margin: 0% 2%;">
                <div class="col col-4">
                    <h1 id="index4"><span class="titre-dot">.</span>Conception</h1>
                ...
                <div class="col col-4" style="margin: 0;">
                    ...
                    <div class="card design">
                        ...
                        <p id="index5" class="content">Vos clients méritent un site clair, facile de navigation et bien pensé. C’est
                    ...
                    <div class="card web">
                        ...
                        <p id="index6" class="content">En réponse directe au Pôle Design, notre Pôle Web s’occupe de réaliser votre
                    ...
                    <div  class="card redaction">
                        ...
                        <p id="index7" class="content">Parce que votre puissance de communication passe aussi par les mots, nous
