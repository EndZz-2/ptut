...
<head>
    ...
    <title id="apropostitle">Codd(in) | A propos</title>
        ...
        <div class="row">
            <div class="text">
                ...
                <p class="event apropos2">
                    <span id="apropos2" class="cms-content">
                        ...
                        Nous mettons un point d’honneur à entretenir une certaine proximité avec nos clients en
                        identifiant
                        leurs envies, leurs besoins et en leur proposant des idées en adéquation avec leurs valeurs.
                        Toujours en veille, nous nous efforçons de surfer sur les tendances actuelles et proposons des
                        sites
