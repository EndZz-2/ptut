        ...
        post('./include/mdpverif.inc.php', "id=" + id + "&pass=" + pass.value, function () {
            if (this.readyState == 4 && this.status == 200) {
                if (this.response == 'mdp-incorrect') {
                    ...
                    infos.children[0].classList.remove('fa-exclamation-triangle', '--error')
                } else {
...
usern.addEventListener('click', function () {
    ...
    if (infos.children[0].classList.length > 1) {
        infos.classList.remove('--active')
        infos.children[0].classList.remove('fa-times', '--error')
    }
...
passn.addEventListener('click', function () {
    ...
    if (infos1.children[0].classList.length > 1) {
        infos1.classList.remove('--active')
        infos1.children[0].classList.remove('fa-times', '--error')
        infos2.classList.remove('--active')
        infos2.children[0].classList.remove('fa-times', '--error')
    }
